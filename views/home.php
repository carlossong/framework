...
<div class="px-4 py-6 sm:px-0">
    <div class="border-4 border-dashed border-gray-200 rounded-lg h-96 flex flex-col items-center justify-center bg-white shadow-sm">
        ...
        <p class="text-lg text-gray-600 max-w-2xl text-center mb-8">
            Você configurou com sucesso um PHP Mini Framework usando carregamento automático PSR-4, uma arquitetura MVC personalizada, uma camada simples de abstração de banco de dados e estilização de UI moderna com Tailwind CSS.
        </p>
